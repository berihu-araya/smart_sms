...
export default function NewTeacherSubjectPage() {
  ...
  function handleChange(event) {
    ...
    // Clear grade-dependent fields when grade changes
    if (name === "grade_id") {
  ...
  return (
    <div className={styles.page}>
      ...
      <div className={styles.pageHeader}>
        ...
        <p>Assign a teacher to teach a specific subject in a grade and section.</p>
      </div>
      ...
      <form onSubmit={handleSubmit}>
        <div className={styles.formCard}>
          ...
          <div className={styles.section}>
            <div className={styles.sectionHeader}>
              ...
              <div>
                ...
                <p className={styles.sectionSubtitle}>Select the teacher, subject, and class details</p>
              </div>
            </div>
          ...
          <div className={styles.actions}>
            <Link href="/dashboard/teachers/subjects" className={styles.btnSecondary}>
              Cancel
            </Link>
